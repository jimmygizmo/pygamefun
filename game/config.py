...
MAIN_WEAPON_EXP_ANIM_INDEX: int = 0  # Index in anim_specs of the anim_spec item to use for the Player's main projectile kill/finalization (explosion) animation.
